...
class FirebaseClient:
    ...
    def write_database_with_file(self, url):
        ...
        cloud_path = self.storage_utils.generate_filename_for_cloud_storage(
            timestamp, self.uuid)
    ...
    def num_relevant_recordings(self):
        ...
        return len(this_weeks_messages)
    ...
    def fetch_relevant_recordings(self):
        ...
        for msg in this_weeks_messages:
            local_filename = self.storage_utils.generate_filename_for_local_storage_download(
                msg)
    ...
    def upload_file(self, filename):
        ...
        # self.drecorder.firebase_filename).get_url("")
